...
def main(args):
    ...
    (
        ...
        num_classes,
        default_image_size,
    ) = data_loader(dataset, batch_size, image_size, data_use, augment=True)
    ...
    if args.model_type == "vit":
        ...
        optimizer, scheduler, criterion = initialize_optimizer_scheduler_criterion(
            model, args.learning_rate, args.weight_decay, args.patience_value
        )
        ...
        # Initialise optimizer and scheduler
        optimizer, scheduler = initialize_optimizer_scheduler_criterion(
            model, args.learning_rate, args.weight_decay, args.patience_value
        )
        ...
        raise ValueError(
            "Invalid model type provided. Choose 'cnn' or 'vit or vit_dpe'."
        )
